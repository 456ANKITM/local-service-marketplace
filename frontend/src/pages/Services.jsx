...
//   if (error) return <p className="text-center mt-10">Error loading workers</p>;
...
//     <div
//       key={worker._id}
//       className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 p-5 flex flex-col justify-between"
//     >
//       {/* Top Section */}
//       <div>
//         {/* Header */}
...
//                 <MapPin size={14} /> {worker.city || "Location not specified"}
//             </div>
...
//         }
//         className="mt-2 w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-2 rounded-xl font-medium hover:from-blue-600 hover:to-blue-700 transition"
//       >
//         View Profile
//       </button>
//     </div>
